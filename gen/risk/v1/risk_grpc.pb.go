...
const (
	RiskService_AssessPayment_FullMethodName = "/risk.v1.RiskService/AssessPayment"
)
...
type RiskServiceClient interface {
	AssessPayment(ctx context.Context, in *AssessPaymentRequest, opts ...grpc.CallOption) (*AssessPaymentResponse, error)
}
...
func (c *riskServiceClient) AssessPayment(ctx context.Context, in *AssessPaymentRequest, opts ...grpc.CallOption) (*AssessPaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AssessPaymentResponse)
	err := c.cc.Invoke(ctx, RiskService_AssessPayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RiskServiceServer interface {
	AssessPayment(context.Context, *AssessPaymentRequest) (*AssessPaymentResponse, error)
...
func (UnimplementedRiskServiceServer) AssessPayment(context.Context, *AssessPaymentRequest) (*AssessPaymentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AssessPayment not implemented")
}
...
func _RiskService_AssessPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssessPaymentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RiskServiceServer).AssessPayment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RiskService_AssessPayment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RiskServiceServer).AssessPayment(ctx, req.(*AssessPaymentRequest))
	}
...
var RiskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AssessPayment",
			Handler:    _RiskService_AssessPayment_Handler,
		},
	},
